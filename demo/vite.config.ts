...
// Same idea for the `fountain-classify` subpath: alias to source when the sibling is checked out, else
// fall through to the real, published `@sudobility/writing_formats` dependency.
